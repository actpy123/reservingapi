...
import { controlSheet, createSessionSimulation, getAllSessionName, getAllUserControlSheets, getCurrentAssumptions, reserveCalculator, uploadAssumptions } from '@controllers/reserve.controller';
...
orderRoute.get('/session',authenticateRequest, getAllSessionName); //get all session name and id based on user
